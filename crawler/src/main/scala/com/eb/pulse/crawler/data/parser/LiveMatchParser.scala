package com.eb.pulse.crawler.data.parser

import com.eb.pulse.crawler.data.cache.CacheHelper
import com.eb.pulse.crawler.data.model.{LiveMatch, Player, TeamScoreBoard}
import com.eb.pulse.crawler.data.service.{NetworthService, TeamService}
