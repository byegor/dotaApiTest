...
object HttpUtils {
  ...
  val GET_BATCH_OF_MATCHES: String = "https://api.steampowered.com/IDOTA2Match_570/GetMatchHistory/V001/?min_players=10&game_mode=1&key=9EBD51CD27F27324F1554C53BEDA17C3"
  val GET_NEXT_PAGE_OF_MATCHES: String = GET_BATCH_OF_MATCHES + "&start_at_match_id="
  ...
  def getMatchHistoryResults(lastMatchId: Long): JSONObject = {
    val requestUrl = if (lastMatchId == -1) GET_BATCH_OF_MATCHES else GET_NEXT_PAGE_OF_MATCHES + lastMatchId
